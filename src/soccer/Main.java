...
public class Main {
	...
	public static void main(String[] args) {
		public static void main(String[] args) {
	        Map<Integer, PlayerOperation> playerOperations = new HashMap<>();
	        playerOperations.put(INPUT, new PlayerInputOperation());
	        playerOperations.put(UPDATE, new UpdatePlayerOperation());
	        playerOperations.put(DELETE, new DeletePlayerOperation());
	        // Agregar otras operaciones relacionadas con los jugadores...
		...
		while (!flag) {
		        ...
		        PlayerOperation operation = playerOperations.get(num);
		        if (operation != null) {
		            operation.execute();
		        } else {
